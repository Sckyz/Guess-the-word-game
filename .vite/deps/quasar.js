...
function getTopLeftProps(e, t, o) {
  return { top: e[o.anchorOrigin.vertical] - t[o.selfOrigin.vertical], left: e[o.anchorOrigin.horizontal] - t[o.selfOrigin.horizontal] };
}
function setPosition(e) {
  ...
  const { scrollLeft: t, scrollTop: o } = e.el, n = void 0 === e.absoluteOffset ? getAnchorProps(e.anchorEl, true === e.cover ? [0, 0] : e.offset) : getAbsoluteAnchorProps(e.anchorEl, e.absoluteOffset, e.offset);
  let a = { maxHeight: e.maxHeight, maxWidth: e.maxWidth, visibility: "visible" };
  true !== e.fit && true !== e.cover || (a.minWidth = n.width + "px", true === e.cover && (a.minHeight = n.height + "px")), Object.assign(e.el.style, a);
  const l = getTargetProps(e.el);
  let i = getTopLeftProps(n, l, e);
  if (void 0 === e.absoluteOffset || void 0 === e.offset)
    applyBoundaries(i, n, l, e.anchorOrigin, e.selfOrigin);
  else {
    const { top: t2, left: o2 } = i;
    applyBoundaries(i, n, l, e.anchorOrigin, e.selfOrigin);
    let a2 = false;
    if (i.top !== t2) {
      a2 = true;
      const t3 = 2 * e.offset[1];
      n.center = n.top -= t3, n.bottom -= t3 + 2;
    }
    if (i.left !== o2) {
      a2 = true;
      const t3 = 2 * e.offset[0];
      n.middle = n.left -= t3, n.right -= t3 + 2;
    }
    true === a2 && (i = getTopLeftProps(n, l, e), applyBoundaries(i, n, l, e.anchorOrigin, e.selfOrigin));
  }
  a = { top: i.top + "px", left: i.left + "px" }, void 0 !== i.maxHeight && (a.maxHeight = i.maxHeight + "px", n.height > i.maxHeight && (a.minHeight = a.maxHeight)), void 0 !== i.maxWidth && (a.maxWidth = i.maxWidth + "px", n.width > i.maxWidth && (a.minWidth = a.maxWidth)), Object.assign(e.el.style, a), e.el.scrollTop !== o && (e.el.scrollTop = o), e.el.scrollLeft !== t && (e.el.scrollLeft = t);
}
...
var QMenu = createComponent({ name: "QMenu", inheritAttrs: false, props: { ...useAnchorProps, ...useModelToggleProps, ...useDarkProps, ...useTransitionProps, persistent: Boolean, autoClose: Boolean, separateClosePopup: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, fit: Boolean, cover: Boolean, square: Boolean, anchor: { type: String, validator: validatePosition }, self: { type: String, validator: validatePosition }, offset: { type: Array, validator: validateOffset }, scrollTarget: { default: void 0 }, touchPosition: Boolean, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null } }, emits: [...useModelToggleEmits, "click", "escapeKey"], setup(e, { slots: t, emit: o, attrs: n }) {
  ...
  function V(t2) {
    true === O.value && true !== e.noFocus && true !== childHasFocus(d.value, t2.target) && L();
  }
  function H(e2) {
    o("escapeKey"), q(e2);
  }
  function N() {
    const t2 = d.value;
    null !== t2 && null !== k.value && setPosition({ el: t2, offset: e.offset, anchorEl: k.value, anchorOrigin: B.value, selfOrigin: E.value, absoluteOffset: a, fit: e.fit, cover: e.cover, maxHeight: e.maxHeight, maxWidth: e.maxWidth });
  }
  function j() {
  ...
  }), onBeforeUnmount(D), Object.assign(u, { focus: L, updatePosition: N }), $;
} });
var buf;
var bufIdx = 0;
...
function useSlider({ updateValue: e, updatePosition: t, getDragging: o, formAttrs: n }) {
  ...
  function fe(e2, t2, o2, n2) {
    const l2 = [];
    "transparent" !== a.innerTrackColor && l2.push(h("div", { key: "inner", class: j.value, style: U.value })), "transparent" !== a.selectionColor && l2.push(h("div", { key: "selection", class: L.value, style: e2.value })), false !== a.markers && l2.push(h("div", { key: "marker", class: F.value, style: te.value })), n2(l2);
...
var QTabs = createComponent({ name: "QTabs", props: { modelValue: [Number, String], align: { type: String, default: "center", validator: (e) => alignValues$1.includes(e) }, breakpoint: { type: [String, Number], default: 600 }, vertical: Boolean, shrink: Boolean, stretch: Boolean, activeClass: String, activeColor: String, activeBgColor: String, indicatorColor: String, leftIcon: String, rightIcon: String, outsideArrows: Boolean, mobileArrows: Boolean, switchIndicator: Boolean, narrowIndicator: Boolean, inlineLabel: Boolean, noCaps: Boolean, dense: Boolean, contentClass: String, "onUpdate:modelValue": [Function, Array] }, setup(e, { slots: t, emit: o }) {
  ...
  function O() {
    l(() => {
      L({ width: p.value.offsetWidth, height: p.value.offsetHeight });
    });
  }
  function L(t2) {
  ...
  function J(e2) {
    S.push(e2), w.value++, O(), void 0 === e2.routeData || void 0 === n.$route ? c(() => {
      if (true === f.value) {
  ...
  function ee(e2) {
    S.splice(S.indexOf(e2), 1), w.value--, O(), void 0 !== x && void 0 !== e2.routeData && (true === S.every((e3) => void 0 === e3.routeData) && x(), X());
  }
...
var QColor = createComponent({ name: "QColor", props: { ...useDarkProps, ...useFormProps, modelValue: String, defaultValue: String, defaultView: { type: String, default: "spectrum", validator: (e) => ["spectrum", "tune", "palette"].includes(e) }, formatModel: { type: String, default: "auto", validator: (e) => ["auto", "hex", "rgb", "hexa", "rgba"].includes(e) }, palette: Array, noHeader: Boolean, noHeaderTabs: Boolean, noFooter: Boolean, square: Boolean, flat: Boolean, bordered: Boolean, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change"], setup(e, { emit: t }) {
  ...
  }), C = computed(() => ({ background: `hsl(${p.value.h},100%,50%)` })), x = computed(() => ({ top: `${100 - p.value.v}%`, [true === n.lang.rtl ? "right" : "left"]: `${p.value.s}%` })), k = computed(() => void 0 !== e.palette && e.palette.length > 0 ? e.palette : palette), _ = computed(() => "q-color-picker" + (true === e.bordered ? " q-color-picker--bordered" : "") + (true === e.square ? " q-color-picker--square no-border-radius" : "") + (true === e.flat ? " q-color-picker--flat no-shadow" : "") + (true === e.disable ? " disabled" : "") + (true === a.value ? " q-color-picker--dark q-dark" : "")), q = computed(() => {
    return true === e.disable ? { "aria-disabled": "true" } : true === e.readonly ? { "aria-readonly": "true" } : {};
  }), T = computed(() => {
    return [[TouchPan, O, void 0, { prevent: true, stop: true, mouse: true }]];
  });
  function P(e2, o2) {
...
var QDate = createComponent({ name: "QDate", props: { ...useDatetimeProps, ...useFormProps, ...useDarkProps, multiple: Boolean, range: Boolean, title: String, subtitle: String, mask: { default: "YYYY/MM/DD" }, defaultYearMonth: { type: String, validator: yearMonthValidator }, yearsInMonthView: Boolean, events: [Array, Function], eventColor: [String, Function], emitImmediately: Boolean, options: [Array, Function], navigationMinYearMonth: { type: String, validator: yearMonthValidator }, navigationMaxYearMonth: { type: String, validator: yearMonthValidator }, noUnset: Boolean, firstDayOfWeek: [String, Number], todayBtn: Boolean, minimal: Boolean, defaultView: { type: String, default: "Calendar", validator: viewIsValid } }, emits: [...useDatetimeEmits, "rangeStart", "rangeEnd", "navigation"], setup(e, { slots: t, emit: o }) {
  ...
  const p = useFormAttrs(e), v = useFormInject(p), m = ref(null), f = ref(de()), g = ref(u()), b = computed(() => de()), y = computed(() => u()), S = computed(() => c()), w = ref(ve(f.value, g.value)), C = ref(e.defaultView), x = true === a.lang.rtl ? "right" : "left", k = ref(x.value), _ = ref(x.value), q = w.value.year, T = ref(q - q % yearsInterval - (q < 0 ? yearsInterval : 0)), P = ref(null), $ = computed(() => {
  ...
  }), F = computed(() => "persian" === e.calendar ? getDayHash : (e2, t2, o2) => formatDate(new Date(e2.year, e2.month - 1, e2.day, e2.hour, e2.minute, e2.second, e2.millisecond), void 0 === t2 ? f.value : t2, void 0 === o2 ? g.value : o2, e2.year, e2.timezoneOffset)), R = computed(() => A.value.length + O.value.reduce((e2, t2) => e2 + 1 + getDateDiff(L.value(t2.to), L.value(t2.from)), 0)), D = computed(() => {
    ...
    const t2 = A.value[0], o2 = L.value(t2);
    ...
    const e2 = A.value.concat(O.value.map((e3) => e3.from)).sort((e3, t2) => e3.year - t2.year || e3.month - t2.month);
    return e2[0];
  }), I = computed(() => {
    const e2 = A.value.concat(O.value.map((e3) => e3.to)).sort((e3, t2) => t2.year - e3.year || t2.month - e3.month);
    return e2[0];
  }), V = computed(() => {
  ...
  function qe(t2) {
    ...
    if (true === e.multiple)
      if (void 0 !== t2.from) {
        const e2 = getDayHash(t2.from), n2 = getDayHash(t2.to), a2 = A.value.filter((t3) => t3.dateHash < e2 || t3.dateHash > n2), l2 = O.value.filter(({ from: t3, to: o3 }) => o3.dateHash < e2 || t3.dateHash > n2);
  ...
  function Pe(t2, n2, a2) {
    const l2 = A.value.concat(O.value).map((e2) => _e(e2, t2, n2)).filter((e2) => {
...
var QDialog = createComponent({ name: "QDialog", inheritAttrs: false, props: { ...useModelToggleProps, ...useTransitionProps, transitionShow: String, transitionHide: String, persistent: Boolean, autoClose: Boolean, allowFocusOutside: Boolean, noEscDismiss: Boolean, noBackdropDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, noShake: Boolean, seamless: Boolean, maximized: Boolean, fullWidth: Boolean, fullHeight: Boolean, square: Boolean, position: { type: String, default: "standard", validator: (e) => "standard" === e || ["top", "bottom", "left", "right"].includes(e) } }, emits: [...useModelToggleEmits, "shake", "click", "escapeKey"], setup(e, { slots: t, emit: o, attrs: n }) {
  ...
  function E(t2) {
    g(), q(), L(true), r.value = true, w(), null !== d && (((t2 && 0 === t2.type.indexOf("key") ? d.closest('[tabindex]:not([tabindex^="-"])') : void 0) || d).focus(), d = null), m(() => {
  ...
  function L(t2) {
    null !== c && (clearTimeout(c), c = null), true !== t2 && true !== i.value || (F(false), true !== e.seamless && (v(false), removeFocusout(z), removeEscapeKey(O))), true !== t2 && (d = null);
  }
  function F(e2) {
  ...
  return watch(() => e.maximized, (e2) => {
    ...
    v(e2), true === e2 ? (addFocusout(z), addEscapeKey(O)) : (removeFocusout(z), removeEscapeKey(O));
...
var QDrawer = createComponent({ name: "QDrawer", inheritAttrs: false, props: { ...useModelToggleProps, ...useDarkProps, side: { type: String, default: "left", validator: (e) => ["left", "right"].includes(e) }, width: { type: Number, default: 300 }, mini: Boolean, miniToOverlay: Boolean, miniWidth: { type: Number, default: 57 }, breakpoint: { type: Number, default: 1023 }, showIfAbove: Boolean, behavior: { type: String, validator: (e) => ["default", "desktop", "mobile"].includes(e), default: "default" }, bordered: Boolean, elevated: Boolean, overlay: Boolean, persistent: Boolean, noSwipeOpen: Boolean, noSwipeClose: Boolean, noSwipeBackdrop: Boolean }, emits: [...useModelToggleEmits, "onLayout", "miniState"], setup(e, { slots: t, emit: o, attrs: n }) {
  ...
  return watch(m, (t2) => {
    ...
    c.instances[t2] === q && (c.instances[t2] = void 0, c[t2].space = false, c[t2].offset = 0), c.instances[e2] = q, c[e2].size = g.value, c[e2].space = L.value, c[e2].offset = A.value;
  }), watch(c.totalWidth, () => {
    ...
    o("miniState", e2);
  }), c.instances[e.side] = q, le(e.miniToOverlay, g.value), ne("space", L.value), ne("offset", A.value), true === e.showIfAbove && true !== e.modelValue && true === b.value && void 0 !== e["onUpdate:modelValue"] && o("update:modelValue", true), onMounted(() => {
    o("onLayout", L.value), o("miniState", f.value), d = true === e.showIfAbove;
    const t2 = () => {
...
var QTooltip = createComponent({ name: "QTooltip", inheritAttrs: false, props: { ...useAnchorProps, ...useModelToggleProps, ...useTransitionProps, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null }, transitionShow: { default: "jump-down" }, transitionHide: { default: "jump-up" }, anchor: { type: String, default: "bottom middle", validator: validatePosition }, self: { type: String, default: "top middle", validator: validatePosition }, offset: { type: Array, default: () => [14, 14], validator: validateOffset }, scrollTarget: { default: void 0 }, delay: { type: Number, default: 0 }, hideDelay: { type: Number, default: 0 } }, emits: [...useModelToggleEmits], setup(e, { slots: t, emit: o, attrs: n }) {
  let a, l;
  const i = getCurrentInstance(), { proxy: { $q: r } } = i, s = ref(null), u = ref(false), c = computed(() => parsePosition(e.anchor, r.lang.rtl)), d = computed(() => parsePosition(e.self, r.lang.rtl)), p = computed(() => true !== e.persistent), { registerTick: v, removeTick: m } = useTick(), { registerTimeout: f } = useTimeout(), { transitionProps: g, transitionStyle: b } = useTransition(e), { localScrollTarget: y, changeScrollEvent: S, unconfigureScrollTarget: w } = useScrollTarget(e, F), { anchorEl: C, canShow: x, anchorEvents: k } = useAnchor({ showing: u, configureAnchorEl: L }), { show: _, hide: q } = useModelToggle({ showing: u, canShow: x, handleShow: M, handleHide: B, hideOnRouteChange: p, processOnMount: true });
  Object.assign(k, { delayShow: A, delayHide: O });
...
var QEditor = createComponent({ name: "QEditor", props: { ...useDarkProps, ...useFullscreenProps, modelValue: { type: String, required: true }, readonly: Boolean, disable: Boolean, minHeight: { type: String, default: "10rem" }, maxHeight: String, height: String, definitions: Object, fonts: Object, placeholder: String, toolbar: { type: Array, validator: (e) => 0 === e.length || e.every((e2) => e2.length), default() {
  ...
  return onMounted(() => {
    ...
    return h("div", { ref: d, class: P.value, style: { height: true === s.value ? "100%" : null }, ...M.value, onFocusin: L, onFocusout: F }, [t2, h("div", { ref: p, style: T.value, class: $.value, contenteditable: f.value, placeholder: e.placeholder, ...{}, ...c.listeners.value, onInput: B, onKeydown: E, onClick: Q, onBlur: A, onFocus: O, onMousedown: R, onTouchstartPassive: R })]);
  };
} });
...
function useValidate(e, t) {
  ...
  let r, s = 0;
  const u = computed(() => void 0 !== o.rules && null !== o.rules && o.rules.length > 0), c = computed(() => true !== o.disable && true === u.value), d = computed(() => true === o.error || true === a.value), p = computed(() => "string" === typeof o.errorMessage && o.errorMessage.length > 0 ? o.errorMessage : l.value);
  function v() {
...
function useMask(e, t, o, n) {
  ...
  function f() {
    if (c.value = void 0 !== e.mask && e.mask.length > 0 && p(), false === c.value)
      return r = void 0, a = "", void (l = "");
    const t2 = void 0 === NAMED_MASKS[e.mask] ? e.mask : NAMED_MASKS[e.mask], o2 = "string" === typeof e.fillMask && e.fillMask.length > 0 ? e.fillMask.slice(0, 1) : "_", n2 = o2.replace(escRegex, "\\$&"), s2 = [], u2 = [], d2 = [];
  ...
  function S(o2) {
    if (t("keydown", o2), true === shouldIgnoreKey(o2))
      return;
...
var QInput = createComponent({ name: "QInput", inheritAttrs: false, props: { ...useFieldProps, ...useMaskProps, ...useFormProps, modelValue: { required: false }, shadowText: String, type: { type: String, default: "text" }, debounce: [String, Number], autogrow: Boolean, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...useFieldEmits, "paste", "change", "keydown", "click", "animationend"], setup(e, { emit: t, attrs: o }) {
  ...
  const d = ref(null), p = useFormInputNameAttr(e), { innerValue: v, hasMask: m, moveCursorForPaste: f, updateMaskValue: g, onMaskedKeydown: b, onMaskedClick: y } = useMask(e, t, Q, d), S = useFileFormDomProps(e, true), w = computed(() => fieldValueIsFilled(v.value)), C = useKeyComposition(B), x = useFieldState(), k = computed(() => "textarea" === e.type || true === e.autogrow), _ = computed(() => true === k.value || ["text", "search", "url", "tel", "password"].includes(e.type)), q = computed(() => {
    const t2 = { ...x.splitAttrs.listeners.value, onInput: B, onPaste: M, onChange: O, onBlur: L, onFocus: stop };
...
var QScrollArea = createComponent({ name: "QScrollArea", props: { ...useDarkProps, thumbStyle: Object, verticalThumbStyle: Object, horizontalThumbStyle: Object, barStyle: [Array, String, Object], verticalBarStyle: [Array, String, Object], horizontalBarStyle: [Array, String, Object], contentStyle: [Array, String, Object], contentActiveStyle: [Array, String, Object], delay: { type: [String, Number], default: 1e3 }, visible: { type: Boolean, default: null }, tabindex: [String, Number], onScroll: Function }, setup(e, { slots: t, emit: o }) {
  ...
  return watch(() => s.$q.lang.rtl, (e2) => {
    ...
    E = { top: r.vertical.position.value, left: r.horizontal.position.value };
  }), onActivated(() => {
    if (null === E)
      return;
    const e2 = p.value;
    null !== e2 && (setHorizontalScrollPosition(e2, E.left), setVerticalScrollPosition(e2, E.top));
...
function useVirtualScroll({ virtualScrollLength: e, getVirtualScrollTarget: t, getVirtualScrollEl: o, virtualScrollItemSizeComputed: n }) {
  ...
  function $(t2, o2, n2, a2, i2) {
    ...
    requestAnimationFrame(() => {
      ...
      u = v2, setScroll(t2, v2, l.virtualScrollHorizontal, s.lang.rtl), O(n2);
    });
  }
  function M(e2) {
    const t2 = S.value;
  ...
  return onDeactivated(() => {
    ...
    L.cancel();
  }), Object.assign(r, { scrollTo: T, reset: _, refresh: q }), { virtualScrollSliceRange: w, virtualScrollSliceSizeComputed: g, setVirtualScrollSize: Q, onVirtualScrollEvt: L, localResetVirtualScroll: E, padVirtualScroll: A, scrollTo: T, reset: _, refresh: q };
}
...
var QSelect = createComponent({ name: "QSelect", inheritAttrs: false, props: { ...useVirtualScrollProps, ...useFormProps, ...useFieldProps, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: validateNewValueMode }, mapOptions: Boolean, emitValue: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: String, transitionHide: String, transitionDuration: [String, Number], behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: { type: [Number, String], default: void 0 }, onNewValue: Function, onFilter: Function }, emits: [...useFieldEmits, "add", "remove", "inputValue", "newValue", "keyup", "keypress", "keydown", "filterAbort"], setup(e, { slots: t, emit: o }) {
  ...
  const w = ref(null), C = ref(null), x = ref(null), k = ref(null), _ = ref(null), q = useFormInputNameAttr(e), T = useKeyComposition(Pe), P = computed(() => Array.isArray(e.options) ? e.options.length : 0), $ = computed(() => void 0 === e.virtualScrollItemSize ? true === e.optionsDense ? 24 : 48 : e.virtualScrollItemSize), { virtualScrollSliceRange: M, virtualScrollSliceSizeComputed: B, localResetVirtualScroll: E, padVirtualScroll: Q, onVirtualScrollEvt: A, scrollTo: O, setVirtualScrollSize: L } = useVirtualScroll({ virtualScrollLength: P, getVirtualScrollTarget: ke, getVirtualScrollEl: xe, virtualScrollItemSizeComputed: $ }), F = useFieldState(), R = computed(() => {
    ...
    if (true === e.mapOptions && true === Array.isArray(e.options)) {
      const n2 = true === e.mapOptions && void 0 !== d ? d : [], a2 = o2.map((e2) => fe(e2, n2));
  ...
  }), z = computed(() => null === e.optionsDark ? F.isDark.value : e.optionsDark), I = computed(() => fieldValueIsFilled(R.value)), V = computed(() => {
    let t2 = "q-field__input q-placeholder col";
    return true === e.hideSelected || 0 === R.value.length ? [t2, e.inputClass] : (t2 += " q-field__input--padding", void 0 === e.inputClass ? t2 : [t2, e.inputClass]);
  }), H = computed(() => (true === e.virtualScrollHorizontal ? "q-virtual-scroll--horizontal" : "") + (e.popupContentClass ? " " + e.popupContentClass : "")), N = computed(() => 0 === P.value), j = computed(() => R.value.map((e2) => ae.value(e2)).join(", ")), U = computed(() => void 0 !== e.displayValue ? e.displayValue : j.value), K = computed(() => true === e.optionsHtml ? () => true : (e2) => void 0 !== e2 && null !== e2 && true === e2.html), W = computed(() => true === e.displayValueHtml || void 0 === e.displayValue && (true === e.optionsHtml || R.value.some(K.value))), Y = computed(() => true === F.focused.value ? e.tabindex : -1), G = computed(() => {
    const t2 = { tabindex: e.tabindex, role: "combobox", "aria-label": e.label, "aria-readonly": true === e.readonly ? "true" : "false", "aria-autocomplete": true === e.useInput ? "list" : "none", "aria-expanded": true === l.value ? "true" : "false", "aria-controls": `${F.targetUid.value}_lb` };
    return r.value >= 0 && (t2["aria-activedescendant"] = `${F.targetUid.value}_${r.value}`), t2;
  }), X = computed(() => ({ id: `${F.targetUid.value}_lb`, role: "listbox", "aria-multiselectable": true === e.multiple ? "true" : "false" })), Z = computed(() => {
    return R.value.map((e2, t2) => ({ index: t2, opt: e2, html: K.value(e2), selected: true, removeAtIndex: ce, toggleOption: pe, tabindex: Y.value }));
  }), J = computed(() => {
    if (0 === P.value)
      return [];
    const { from: t2, to: o2 } = M.value;
    return e.options.slice(t2, o2).map((o3, n2) => {
      const i2 = true === le.value(o3), s2 = t2 + n2, u2 = { clickable: true, active: false, activeClass: oe.value, manualFocus: true, focused: false, disable: i2, tabindex: -1, dense: e.optionsDense, dark: z.value, role: "option", id: `${F.targetUid.value}_${s2}`, onClick: () => {
        pe(o3);
      } };
      return true !== i2 && (true === ge(o3) && (u2.active = true), r.value === s2 && (u2.focused = true), u2["aria-selected"] = true === u2.active ? "true" : "false", true === a.platform.is.desktop && (u2.onMousemove = () => {
        true === l.value && ve(s2);
      })), { index: s2, opt: o3, html: K.value(o3), label: ae.value(o3), selected: u2.active, focused: u2.focused, toggleOption: pe, setOptionIndex: ve, itemProps: u2 };
    });
  }), ee = computed(() => void 0 !== e.dropdownIcon ? e.dropdownIcon : a.iconSet.arrow.dropdown), te = computed(() => false === e.optionsCover && true !== e.outlined && true !== e.standout && true !== e.borderless && true !== e.rounded), oe = computed(() => void 0 !== e.optionsSelectedClass ? e.optionsSelectedClass : void 0 !== e.color ? `text-${e.color}` : ""), ne = computed(() => he(e.optionValue, "value")), ae = computed(() => he(e.optionLabel, "label")), le = computed(() => he(e.optionDisable, "disable")), ie = computed(() => R.value.map((e2) => ne.value(e2))), re = computed(() => {
    const e2 = { onInput: Pe, onChange: T, onKeydown: Ce, onKeyup: Se, onKeypress: we, onFocus: be, onClick(e3) {
      true === p && stop(e3);
    } };
    return e2.onCompositionstart = e2.onCompositionupdate = e2.onCompositionend = T, e2;
  });
  function se(t2) {
    return true === e.emitValue ? ne.value(t2) : t2;
  }
  function ue(t2) {
  ...
  function de(t2, n2) {
    const a2 = se(t2);
    if (true !== e.multiple)
      return true === e.fillInput && Me(ae.value(t2), true, true), void o("update:modelValue", a2);
    if (0 === R.value.length)
      return o("add", { index: 0, value: a2 }), void o("update:modelValue", true === e.multiple ? [a2] : a2);
    if (true === n2 && true === ge(t2))
      return;
  ...
  function pe(t2, n2) {
    if (true !== F.editable.value || void 0 === t2 || true === le.value(t2))
      return;
    const a2 = ne.value(t2);
    if (true !== e.multiple)
      return true !== n2 && (Me(true === e.fillInput ? ae.value(t2) : "", true, true), He()), null !== C.value && C.value.focus(), void (0 !== R.value.length && true === isDeepEqual(ne.value(R.value[0]), a2) || o("update:modelValue", true === e.emitValue ? a2 : t2));
    if ((true !== p || true === u.value) && F.focus(), be(), 0 === R.value.length) {
      const n3 = true === e.emitValue ? a2 : t2;
      return o("add", { index: 0, value: n3 }), void o("update:modelValue", true === e.multiple ? [n3] : n3);
    }
    const l2 = e.modelValue.slice(), i2 = ie.value.findIndex((e2) => isDeepEqual(e2, a2));
    if (i2 > -1)
  ...
  function me(t2 = 1, o2) {
    if (true === l.value) {
      ...
      } while (-1 !== n2 && n2 !== r.value && true === le.value(e.options[n2]));
      r.value !== n2 && (ve(n2), O(n2), true !== o2 && true === e.useInput && true === e.fillInput && $e(n2 >= 0 ? ae.value(e.options[n2]) : m));
    }
  }
  function fe(t2, o2) {
    const n2 = (e2) => isDeepEqual(ne.value(e2), t2);
  ...
  function ge(e2) {
    const t2 = ne.value(e2);
    return void 0 !== ie.value.find((e3) => isDeepEqual(e3, t2));
  }
  function be(t2) {
    true === e.useInput && null !== C.value && (void 0 === t2 || C.value === t2.target && t2.target.value === j.value) && C.value.select();
  }
  function ye(e2) {
    true === isKeyCode(e2, 27) && true === l.value && (stop(e2), He(), Ne()), o("keyup", e2);
  }
  function Se(t2) {
    const { value: o2 } = t2.target;
    if (void 0 === t2.keyCode)
      if (t2.target.value = "", null !== y && (clearTimeout(y), y = null), Ne(), "string" === typeof o2 && o2.length > 0) {
        const t3 = o2.toLocaleLowerCase(), n2 = (o3) => {
          const n3 = e.options.find((e2) => o3.value(e2).toLocaleLowerCase() === t3);
          return void 0 !== n3 && (-1 === R.value.indexOf(n3) ? pe(n3) : He(), true);
        }, a2 = (e2) => {
          true !== n2(ne) && true !== n2(ae) && true !== e2 && Be(o2, true, () => a2(true));
        };
        a2();
      } else
        F.clearValue(t2);
  ...
  function Ce(t2) {
    ...
    if (40 === t2.keyCode && true !== F.innerLoading.value && false === l.value)
      return stopAndPrevent(t2), void Ve();
    if (8 === t2.keyCode && true !== e.hideSelected && 0 === s.value.length)
      return void (true === e.multiple && true === Array.isArray(e.modelValue) ? ue(e.modelValue.length - 1) : true !== e.multiple && null !== e.modelValue && o("update:modelValue", null));
    35 !== t2.keyCode && 36 !== t2.keyCode || "string" === typeof s.value && 0 !== s.value.length || (stopAndPrevent(t2), r.value = -1, me(36 === t2.keyCode ? 1 : -1, e.multiple)), 33 !== t2.keyCode && 34 !== t2.keyCode || void 0 === B.value || (stopAndPrevent(t2), r.value = Math.max(-1, Math.min(P.value, r.value + (33 === t2.keyCode ? -1 : 1) * B.value.view)), me(33 === t2.keyCode ? 1 : -1, e.multiple)), 38 !== t2.keyCode && 40 !== t2.keyCode || (stopAndPrevent(t2), me(38 === t2.keyCode ? -1 : 1, e.multiple));
    const i2 = P.value;
    if ((void 0 === g || b < Date.now()) && (g = ""), i2 > 0 && true !== e.useInput && void 0 !== t2.key && 1 === t2.key.length && false === t2.altKey && false === t2.ctrlKey && false === t2.metaKey && (32 !== t2.keyCode || g.length > 0)) {
      true !== l.value && Ve(t2);
      ...
      let s2 = r.value;
      if (true === n3 || s2 < 0 || true !== a3.test(ae.value(e.options[s2])))
        do {
          s2 = normalizeToInterval(s2 + 1, -1, i2 - 1);
        } while (s2 !== r.value && (true === le.value(e.options[s2]) || true !== a3.test(ae.value(e.options[s2]))));
      r.value !== s2 && nextTick(() => {
        ve(s2), O(s2), s2 >= 0 && true === e.useInput && true === e.fillInput && $e(ae.value(e.options[s2]));
      });
        ...
        if (true === n2) {
          const t3 = (t4, o2) => {
            ...
            if (void 0 === t4 || null === t4)
              return;
            Me("", true !== e.multiple, true);
            const n3 = "toggle" === o2 ? pe : de;
            n3(t4, "add-unique" === o2), true !== e.multiple && (null !== C.value && C.value.focus(), He());
          };
          if (void 0 !== e.onNewValue ? o("newValue", s.value, t3) : t3(s.value), true !== e.multiple)
            return;
        }
        true === l.value ? Ie() : true !== F.innerLoading.value && Ve();
      }
  }
  function xe() {
    return true === p ? _.value : null !== x.value && null !== x.value.contentEl ? x.value.contentEl : void 0;
  }
  function ke() {
    return xe();
  }
  function _e() {
    return true === e.hideSelected ? [] : void 0 !== t["selected-item"] ? Z.value.map((e2) => t["selected-item"](e2)).slice() : void 0 !== t.selected ? [].concat(t.selected()) : true === e.useChips ? Z.value.map((t2, o2) => h(QChip, { key: "option-" + o2, removable: true === F.editable.value && true !== le.value(t2.opt), dense: true, textColor: e.color, tabindex: Y.value, onRemove() {
      t2.removeAtIndex(o2);
    } }, () => h("span", { class: "ellipsis", [true === t2.html ? "innerHTML" : "textContent"]: ae.value(t2.opt) }))) : [h("span", { [true === W.value ? "innerHTML" : "textContent"]: U.value })];
  }
  function qe() {
    if (true === N.value)
  ...
  function Pe(t2) {
    null !== y && (clearTimeout(y), y = null), t2 && t2.target && true === t2.target.qComposing || ($e(t2.target.value || ""), v = true, m = s.value, true === F.focused.value || true === p && true !== u.value || F.focus(), void 0 !== e.onFilter && (y = setTimeout(() => {
      y = null, Be(s.value);
    }, e.inputDebounce)));
  }
  function $e(e2) {
    s.value !== e2 && (s.value = e2, o("inputValue", e2));
  }
  function Me(t2, o2, n2) {
    v = true !== n2, true === e.useInput && ($e(t2), true !== o2 && true === n2 || (m = t2), true !== o2 && Be(t2));
  }
  function Be(t2, a2, i2) {
    if (void 0 === e.onFilter || true !== a2 && true !== F.focused.value)
      return;
    true === F.innerLoading.value ? o("filterAbort") : (F.innerLoading.value = true, c.value = true), "" !== t2 && true !== e.multiple && R.value.length > 0 && true !== v && t2 === ae.value(R.value[0]) && (t2 = "");
    const r2 = setTimeout(() => {
      true === l.value && (l.value = false);
    }, 10);
    null !== S && clearTimeout(S), S = r2, o("filter", t2, (e2, t3) => {
      true !== a2 && true !== F.focused.value || S !== r2 || (clearTimeout(S), "function" === typeof e2 && e2(), c.value = false, nextTick(() => {
        F.innerLoading.value = false, true === F.editable.value && (true === a2 ? true === l.value && He() : true === l.value ? je(true) : l.value = true), "function" === typeof t3 && nextTick(() => {
          t3(n);
      ...
      true === F.focused.value && S === r2 && (clearTimeout(S), F.innerLoading.value = false, c.value = false), true === l.value && (l.value = false);
    });
  }
  function Ee() {
    return h(QMenu, { ref: x, class: H.value, style: e.popupContentStyle, modelValue: l.value, fit: true !== e.menuShrink, cover: true === e.optionsCover && true !== N.value && true !== e.useInput, anchor: e.menuAnchor, self: e.menuSelf, offset: e.menuOffset, dark: z.value, noParentEvent: true, noRefocus: true, noFocus: true, square: te.value, transitionShow: e.transitionShow, transitionHide: e.transitionHide, transitionDuration: e.transitionDuration, separateClosePopup: true, ...X.value, onScrollPassive: A, onBeforeShow: We, onBeforeHide: Qe, onShow: Ae }, qe);
  }
  function Qe(e2) {
    Ye(e2), Ie();
  }
  ...
  function Fe() {
    const o2 = [h(QField, { class: `col-auto ${F.fieldClass.value}`, ...D.value, for: F.targetUid.value, dark: z.value, square: true, loading: c.value, itemAligned: false, filled: true, stackLabel: s.value.length > 0, ...F.splitAttrs.listeners.value, onFocus: Oe, onBlur: Le }, { ...t, rawControl: () => F.getControl(true), before: void 0, after: void 0 })];
    return true === l.value && o2.push(h("div", { ref: _, class: H.value + " scroll", style: e.popupContentStyle, ...X.value, onClick: prevent, onScrollPassive: A }, qe())), h(QDialog, { ref: k, modelValue: i.value, position: true === e.useInput ? "top" : void 0, transitionShow: f, transitionHide: e.transitionHide, transitionDuration: e.transitionDuration, onBeforeShow: We, onBeforeHide: Re, onHide: De, onShow: ze }, () => h("div", { class: "q-select__dialog" + (true === z.value ? " q-select__dialog--dark q-dark" : "") + (true === u.value ? " q-select__dialog--focused" : "") }, o2));
  }
  function Re(e2) {
    Ye(e2), null !== k.value && k.value.__updateRefocusTarget(F.rootRef.value.querySelector(".q-field__native > [tabindex]:last-child")), F.focused.value = false;
  }
  function De(e2) {
    He(), false === F.focused.value && o("blur", e2), Ne();
  }
  function ze() {
    const e2 = document.activeElement;
    null !== e2 && e2.id === F.targetUid.value || null === C.value || C.value === e2 || C.value.focus(), L();
  }
  function Ie() {
    true !== i.value && (r.value = -1, true === l.value && (l.value = false), false === F.focused.value && (null !== S && (clearTimeout(S), S = null), true === F.innerLoading.value && (o("filterAbort"), F.innerLoading.value = false, c.value = false)));
  }
  function Ve(o2) {
    true === F.editable.value && (true === p ? (F.onControlFocusin(o2), i.value = true, nextTick(() => {
      F.focus();
    })) : F.focus(), void 0 !== e.onFilter ? Be(s.value) : true === N.value && void 0 === t["no-option"] || (l.value = true));
  }
  function He() {
    i.value = false, Ie();
  }
  function Ne() {
    true === e.useInput && Me(true !== e.multiple && true === e.fillInput && R.value.length > 0 && ae.value(R.value[0]) || "", true, true);
  }
  function je(t2) {
    let o2 = -1;
    if (true === t2) {
      if (R.value.length > 0) {
        const t3 = ne.value(R.value[0]);
        o2 = e.options.findIndex((e2) => isDeepEqual(ne.value(e2), t3));
      }
      E(o2);
    }
    ve(o2);
  ...
  function Ue(e2, t2) {
    true === l.value && false === F.innerLoading.value && (E(-1, true), nextTick(() => {
      true === l.value && false === F.innerLoading.value && (e2 > t2 ? E() : je(true));
    }));
  }
  function Ke() {
  ...
  function We(e2) {
    void 0 !== e2 && stop(e2), o("popupShow", e2), F.hasPopupOpen = true, F.onControlFocusin(e2);
  }
  function Ye(e2) {
    void 0 !== e2 && stop(e2), o("popupHide", e2), F.hasPopupOpen = false, F.onControlFocusout(e2);
  }
  function Ge() {
    p = (true === a.platform.is.mobile || "dialog" === e.behavior) && ("menu" !== e.behavior && (true !== e.useInput || (void 0 !== t["no-option"] || void 0 !== e.onFilter || false === N.value))), f = true === a.platform.is.ios && true === p && true === e.useInput ? "fade" : e.transitionShow;
  }
  return watch(R, (t2) => {
    d = t2, true === e.useInput && true === e.fillInput && true !== e.multiple && true !== F.innerLoading.value && (true !== i.value && true !== l.value || true !== I.value) && (true !== v && Ne(), true !== i.value && true !== l.value || Be(""));
  }, { immediate: true }), watch(() => e.fillInput, Ne), watch(l, je), watch(P, Ue), onBeforeUpdate(Ge), onUpdated(Ke), Ge(), onBeforeUnmount(() => {
    null !== y && clearTimeout(y);
  }), Object.assign(n, { showPopup: Ve, hidePopup: He, removeAtIndex: ue, add: de, toggleOption: pe, getOptionIndex: () => r.value, setOptionIndex: ve, moveOptionSelection: me, filter: Be, updateMenuPosition: Ke, updateInputValue: Me, isOptionSelected: ge, getEmittingOptionValue: se, isOptionDisabled: (...e2) => true === le.value.apply(null, e2), getOptionValue: (...e2) => ne.value.apply(null, e2), getOptionLabel: (...e2) => ae.value.apply(null, e2) }), Object.assign(F, { innerValue: R, fieldClass: computed(() => `q-select q-field--auto-height q-select--with${true !== e.useInput ? "out" : ""}-input q-select--with${true !== e.useChips ? "out" : ""}-chips q-select--${true === e.multiple ? "multiple" : "single"}`), inputRef: w, targetRef: C, hasValue: I, showPopup: Ve, floatingLabel: computed(() => true !== e.hideSelected && true === I.value || "number" === typeof s.value || s.value.length > 0 || fieldValueIsFilled(e.displayValue)), getControlChild: () => {
    if (false !== F.editable.value && (true === i.value || true !== N.value || void 0 !== t["no-option"]))
      return true === p ? Fe() : Ee();
    ...
    if (prevent(e2), true !== p && true === l.value)
      return Ie(), void (null !== C.value && C.value.focus());
    Ve(e2);
  } }, getControl: (t2) => {
    const o2 = _e(), n2 = true === t2 || true !== i.value || true !== p;
    if (true === e.useInput)
      o2.push(Te(t2, n2));
    else if (true === F.editable.value) {
      const a3 = true === n2 ? G.value : void 0;
      o2.push(h("input", { ref: true === n2 ? C : void 0, key: "d_t", class: "q-select__focus-target", id: true === n2 ? F.targetUid.value : void 0, value: U.value, readonly: true, "data-autofocus": true === t2 || true === e.autofocus || void 0, ...a3, onKeydown: Ce, onKeyup: ye, onKeypress: we })), true === n2 && "string" === typeof e.autocomplete && e.autocomplete.length > 0 && o2.push(h("input", { class: "q-select__autocomplete-input", autocomplete: e.autocomplete, tabindex: -1, onKeyup: Se }));
    }
    if (void 0 !== q.value && true !== e.disable && ie.value.length > 0) {
      const t3 = ie.value.map((e2) => h("option", { value: e2, selected: true }));
    ...
    return h("div", { class: "q-field__native row items-center", ...a2, ...F.splitAttrs.listeners.value }, o2);
  }, getInnerAppend: () => true !== e.loading && true !== c.value && true !== e.hideDropdownIcon ? [h(QIcon, { class: "q-select__dropdown-icon" + (true === l.value ? " rotate-180" : ""), name: ee.value })] : null }), useField(F);
} });
...
var QTable = createComponent({ name: "QTable", props: { rows: { type: Array, default: () => [] }, rowKey: { type: [String, Function], default: "id" }, columns: Array, loading: Boolean, iconFirstPage: String, iconPrevPage: String, iconNextPage: String, iconLastPage: String, title: String, hideHeader: Boolean, grid: Boolean, gridHeader: Boolean, dense: Boolean, flat: Boolean, bordered: Boolean, square: Boolean, separator: { type: String, default: "horizontal", validator: (e) => ["horizontal", "vertical", "cell", "none"].includes(e) }, wrapCells: Boolean, virtualScroll: Boolean, virtualScrollTarget: { default: void 0 }, ...commonVirtPropsObj, noDataLabel: String, noResultsLabel: String, loadingLabel: String, selectedRowsLabel: Function, rowsPerPageLabel: String, paginationLabel: Function, color: { type: String, default: "grey-8" }, titleClass: [String, Array, Object], tableStyle: [String, Array, Object], tableClass: [String, Array, Object], tableHeaderStyle: [String, Array, Object], tableHeaderClass: [String, Array, Object], cardContainerClass: [String, Array, Object], cardContainerStyle: [String, Array, Object], cardStyle: [String, Array, Object], cardClass: [String, Array, Object], hideBottom: Boolean, hideSelectedBanner: Boolean, hideNoData: Boolean, hidePagination: Boolean, onRowClick: Function, onRowDblclick: Function, onRowContextmenu: Function, ...useDarkProps, ...useFullscreenProps, ...useTableColumnSelectionProps, ...useTableFilterProps, ...useTablePaginationProps, ...useTableRowExpandProps, ...useTableRowSelectionProps, ...useTableSortProps }, emits: ["request", "virtualScroll", ...useFullscreenEmits, ...useTableRowExpandEmits, ...useTableRowSelectionEmits], setup(e, { slots: t, emit: o }) {
  ...
  function we(e2) {
    true === E.value && (e2 = false), L(T.value.map(s.value), T.value, e2);
  }
  const Ce = computed(() => {
...
var QTime = createComponent({ name: "QTime", props: { ...useDarkProps, ...useFormProps, ...useDatetimeProps, mask: { default: null }, format24h: { type: Boolean, default: null }, defaultDate: { type: String, validator: (e) => /^-?[\d]+\/[0-1]\d\/[0-3]\d$/.test(e) }, options: Function, hourOptions: Array, minuteOptions: Array, secondOptions: Array, withSeconds: Boolean, nowBtn: Boolean }, emits: useDatetimeEmits, setup(e, { slots: t, emit: o }) {
  ...
  const m = ref(null), f = computed(() => V()), g = computed(() => s()), b = computed(() => H()), y = __splitDate(e.modelValue, f.value, g.value, e.calendar, b.value), S = ref(getViewByModel(y)), w = ref(y), C = ref(null === y.hour || y.hour < 12), x = computed(() => `q-time q-time--${true === e.landscape ? "landscape" : "portrait"}` + (true === l.value ? " q-time--dark q-dark" : "") + (true === e.disable ? " disabled" : true === e.readonly ? " q-time--readonly" : "") + (true === e.bordered ? " q-time--bordered" : "") + (true === e.square ? " q-time--square no-border-radius" : "") + (true === e.flat ? " q-time--flat no-shadow" : "")), k = computed(() => {
  ...
  }), Q = computed(() => null !== M.value ? D(0, 59, M.value) : null), A = computed(() => null !== B.value ? D(0, 59, B.value) : null), O = computed(() => {
    switch (S.value) {
      case "hour":
        return E.value;
      case "minute":
    ...
    let e2, t2, o2 = 0, n2 = 1;
    const a2 = null !== O.value ? O.value.values : void 0;
  ...
  function N() {
    return true === vmIsDestroyed(n) || null !== O.value && (0 === O.value.values.length || "hour" === S.value && true !== _.value && 0 === E.value[true === C.value ? "am" : "pm"].values.length);
  }
  function j() {
  ...
  function W(e2, t2, o2) {
    ...
    if (r2 = n2.top < t2.top ? t2.left < n2.left ? 90 - r2 : 270 + r2 : t2.left < n2.left ? r2 + 90 : 270 - r2, "hour" === S.value) {
      if (i2 = r2 / 30, null !== E.value) {
        const e3 = true !== _.value ? true === C.value : E.value.am.values.length > 0 && E.value.pm.values.length > 0 ? l2 >= t2.dist : E.value.am.values.length > 0;
...
var QTree = createComponent({ name: "QTree", props: { ...useDarkProps, nodes: { type: Array, required: true }, nodeKey: { type: String, required: true }, labelKey: { type: String, default: "label" }, childrenKey: { type: String, default: "children" }, dense: Boolean, color: String, controlColor: String, textColor: String, selectedColor: String, icon: String, tickStrategy: { type: String, default: "none", validator: (e) => tickStrategyOptions.includes(e) }, ticked: Array, expanded: Array, selected: {}, noSelectionUnset: Boolean, defaultExpandAll: Boolean, accordion: Boolean, filter: String, filterMethod: Function, duration: Number, noConnectors: Boolean, noTransition: Boolean, noNodesLabel: String, noResultsLabel: String }, emits: ["update:expanded", "update:ticked", "update:selected", "lazyLoad", "afterShow", "afterHide"], setup(e, { slots: t, emit: o }) {
  ...
  const c = computed(() => `q-tree q-tree--${true === e.dense ? "dense" : "standard"}` + (true === e.noConnectors ? " q-tree--no-connectors" : "") + (true === l.value ? " q-tree--dark" : "") + (void 0 !== e.color ? ` text-${e.color}` : "")), d = computed(() => void 0 !== e.selected), p = computed(() => e.icon || a.iconSet.tree.icon), v = computed(() => e.controlColor || e.color), m = computed(() => void 0 !== e.textColor ? ` text-${e.textColor}` : ""), f = computed(() => {
    ...
    const t2 = {}, o2 = (n2, a2) => {
      const l2 = n2.tickStrategy || (a2 ? a2.tickStrategy : e.tickStrategy), u2 = n2[e.nodeKey], c2 = n2[e.childrenKey] && n2[e.childrenKey].length > 0, p2 = true !== n2.disabled && true === d.value && false !== n2.selectable, v2 = true !== n2.disabled && false !== n2.expandable, m2 = "none" !== l2, f2 = "strict" === l2, h2 = "leaf-filtered" === l2, b2 = "leaf" === l2 || "leaf-filtered" === l2;
  ...
  function A(o2) {
    ...
    return void 0 !== c2 && (c2 = h("div", { class: "q-tree__node-body relative-position" }, [h("div", { class: m.value }, [c2(d2)])])), h("div", { key: n2, class: `q-tree__node relative-position q-tree__node--${true === s2 ? "parent" : "child"}` }, [h("div", { class: "q-tree__node-header relative-position row no-wrap items-center" + (true === a2.link ? " q-tree__node--link q-hoverable q-focusable" : "") + (true === a2.selected ? " q-tree__node--selected" : "") + (true === a2.disabled ? " q-tree__node--disabled" : ""), tabindex: true === a2.link ? 0 : -1, onClick: (e2) => {
      ...
      true !== shouldIgnoreKey(e2) && (13 === e2.keyCode ? L(o2, a2, e2, true) : 32 === e2.keyCode && F(o2, a2, e2, true));
  ...
  function L(t2, n2, a2, l2) {
    true !== l2 && false !== n2.selectable && O(n2.key), d.value && n2.selectable ? false === e.noSelectionUnset ? o("update:selected", n2.key !== e.selected ? n2.key : null) : n2.key !== e.selected && o("update:selected", void 0 === n2.key ? null : n2.key) : F(t2, n2, a2, l2), "function" === typeof t2.handler && t2.handler(t2);
  }
  function F(e2, t2, o2, n2) {
    void 0 !== o2 && stopAndPrevent(o2), true !== n2 && false !== t2.selectable && O(t2.key), _(t2.key, !t2.expanded, e2, t2);
  }
  function R(e2, t2) {
...
function getRenderer(e) {
  ...
  const u = computed(() => true !== o.disable && true !== o.readonly), c = ref(false), d = ref(null), p = ref(null), v = { files: ref([]), queuedFiles: ref([]), uploadedFiles: ref([]), uploadedSize: ref(0), updateFileStatus: s, isAlive: () => false === vmIsDestroyed(t) }, { pickFiles: m, addFiles: f, onDragover: g, onDragleave: b, processFiles: y, getDndNode: S, maxFilesNumber: w, maxTotalSizeNumber: C } = useFile({ editable: u, dnd: c, getFileInput: F, addFilesToQueue: R });
  ...
  function E() {
    false === o.disable && A(["uploaded"], () => {
      v.uploadedFiles.value = [];
    });
  }
  function Q() {
    A(["idle", "failed"], ({ size: e2 }) => {
  ...
  function F() {
    return p.value || d.value.getElementsByClassName("q-uploader__input")[0];
  }
  function R(e2, t2) {
  ...
  function I() {
    return h("input", { ref: p, class: "q-uploader__input overflow-hidden absolute-full", tabindex: -1, type: "file", title: "", accept: o.accept, multiple: true === o.multiple ? "multiple" : void 0, capture: o.capture, onMousedown: stop, onClick: m, onChange: R });
  }
  function V() {
    return void 0 !== n.header ? n.header(N) : [h("div", { class: "q-uploader__header-content column" }, [h("div", { class: "flex flex-center no-wrap q-gutter-xs" }, [z(v.queuedFiles.value.length > 0, "removeQueue", Q), z(v.uploadedFiles.value.length > 0, "removeUploaded", E), true === v.isUploading.value ? h(QSpinner, { class: "q-uploader__spinner" }) : null, h("div", { class: "col column justify-center" }, [void 0 !== o.label ? h("div", { class: "q-uploader__title" }, [o.label]) : null, h("div", { class: "q-uploader__subtitle" }, [q.value + " / " + _.value])]), z(T.value, "add"), z(false === o.hideUploadBtn && true === P.value, "upload", v.upload), z(v.isUploading.value, "clear", v.abort)])])];
  }
  function H() {
    return void 0 !== n.list ? n.list(N) : v.files.value.map((e2) => h("div", { key: e2.__key, class: "q-uploader__file relative-position" + (true !== o.noThumbnails && void 0 !== e2.__img ? " q-uploader__file--img" : "") + ("failed" === e2.__status ? " q-uploader__file--failed" : "uploaded" === e2.__status ? " q-uploader__file--uploaded" : ""), style: true !== o.noThumbnails && void 0 !== e2.__img ? { backgroundImage: 'url("' + e2.__img.src + '")' } : null }, [h("div", { class: "q-uploader__file-header row flex-center no-wrap" }, ["failed" === e2.__status ? h(QIcon, { class: "q-uploader__file-status", name: i.iconSet.type.negative, color: "negative" }) : null, h("div", { class: "q-uploader__file-header-content col" }, [h("div", { class: "q-uploader__title" }, [e2.name]), h("div", { class: "q-uploader__subtitle row items-center no-wrap" }, [e2.__sizeLabel + " / " + e2.__progressLabel])]), "uploading" === e2.__status ? h(QCircularProgress, { value: e2.__progress, min: 0, max: 1, indeterminate: 0 === e2.__progress }) : h(QBtn, { round: true, dense: true, flat: true, icon: i.iconSet.uploader["uploaded" === e2.__status ? "done" : "clear"], onClick: () => {
      O(e2);
    } })])]));
  }
  ...
  const N = {};
  for (const h2 in v)
    true === isRef(v[h2]) ? injectProp(N, h2, () => v[h2].value) : N[h2] = v[h2];
  return Object.assign(N, { upload: D, reset: B, removeUploadedFiles: E, removeQueuedFiles: Q, removeFile: O, pickFiles: m, addFiles: f }), injectMultipleProps(N, { canAddFiles: () => T.value, canUpload: () => P.value, uploadSizeLabel: () => q.value, uploadProgressLabel: () => _.value }), Object.assign(l, N), () => {
    const e2 = [h("div", { class: M.value }, V()), h("div", { class: "q-uploader__list scroll" }, H()), S("uploader")];
...
function morph(e) {
  ...
  const P = () => {
    ...
    const B = () => {
      ...
      a2.insertBefore(Q, A);
      const { borderWidth: O, borderStyle: L, borderColor: F, borderRadius: R, backgroundColor: D, transform: z, position: I, cssText: V } = getComputedStyle$1(e2, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), H = e2.classList.toString(), N = e2.style.cssText;
...
var EventBus = class {
  ...
  off(e, t) {
    const o = this.__stack[e], n = [];
    return void 0 !== o && t && (o.forEach((e2) => {
      e2.fn !== t && e2.fn.__callback !== t && n.push(e2);
    }), 0 !== n.length ? this.__stack[e] = n : delete this.__stack[e]), this;
  }
};
function clean(e) {
  setTimeout(() => {
...
var Quasar = { version: "2.11.10", install(e, t, o) {
